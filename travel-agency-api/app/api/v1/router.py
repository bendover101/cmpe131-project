...
from app.api.v1.endpoints import travel, booking, rapidapi
from app.api.v1 import hostels, flights, attractions 
...
api_router.include_router(attractions.router, tags=["search"])